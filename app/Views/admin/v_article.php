...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= base_url('admin/sukses')?>">Admin Travel</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h3 class ="text-center">Foto Destinasi</h3>
                                        <div class="row">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        ?>
                                        <li class="list-group-item"><?= $row->nama_wisata?></li>
                                       <?php
                                       endforeach;?>
                                        </ul>
